    ...
    table.render({
        ...
        cols: [
            [
                ...
                {
                    field: 'nickname', width: 150, title: '昵称', templet: function (data) {
                        return data.nickname;
                    }
                },
                {
                    field: 'aid', width: 150, title: '文章链接', templet: function (data) {
                        let href = '/article/' + data.aid;
    ...
    table.on('tool(currentTableFilter)', function (obj) {
        ...
        if (obj.event === 'delete') {
            ...
            var index = layer.open({
                ...
                shadeClose: true,
                area: ['50%', '50%'],
                content: '/admin/comment/add?pid=' + data.id + '&aid=' + data.aid,
            });
